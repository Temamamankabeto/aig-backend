...
Route::middleware(['auth:sanctum', 'role:Cashier|General Admin'])->group(function () {
    ...
    */
    ...
    Route::post('/cashier/orders/{id}/receive-payment', [CashierOrderController::class, 'receivePayment']);
